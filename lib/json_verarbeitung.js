       ...
       //if(task.hasOwnProperty('content')){task.content}else{""};
        try {
            ...
            if(task.description == ""){
                ...
                description_neu = task.description;
            }

            if (adapter.config.json_due_date) { if(task.hasOwnProperty('due.date')){ baue_json = baue_json + ', "' + adapter.config.json_due_date_name + '":"' + task.due.date + '"' }else{baue_json = baue_json + ', "' + adapter.config.json_due_date_name + '":"' + " " + '"' } };
            if (adapter.config.json_due_string) { if(task.hasOwnProperty('due.string')){ baue_json = baue_json + ', "' + adapter.config.json_due_string_name + '":"' + task.due.string + '"' }else{baue_json = baue_json + ', "' + adapter.config.json_due_string_name + '":"' + " " + '"' } };
            if (adapter.config.json_due_recurring) { if(task.hasOwnProperty('due.recurring')){ baue_json = baue_json + ', "' + adapter.config.json_due_recurring_name + '":"' + task.due.recurring + '"' }else{baue_json = baue_json + ', "' + adapter.config.json_due_recurring_name + '":"' + " " + '"' } };
            ...
            if (adapter.config.json_description) { if(task.hasOwnProperty('description')){ baue_json = baue_json + ', "' + adapter.config.json_description_name + '":"' + description_neu + '"' }else{baue_json = baue_json + ', "' + adapter.config.json_description_name + '":"' + " " + '"' } };
            ...
            //rename(adapter, task.label_ids , labels, "labels")
